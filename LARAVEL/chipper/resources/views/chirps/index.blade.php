<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('chirps.store') }}">
            @csrf
            <textarea name="message" placeholder="{{ __('What\'s on your mind?') }}" class="block w-full border-gray-300 focus:border-indigo-300 focus:ring
focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">{{ old('message') }}</textarea>
                ...
                <div class="flex-1">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            @unless ($chirp->created_at->eq($chirp->updated_at)) <!-- va  mirar si las fecha son iguales bien y si son diferentes editafo -->
...
2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
